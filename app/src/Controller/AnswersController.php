...
class AnswersController extends  AppController
{
    ...
    public function add()
    {
        ...
        return $this->redirect(['controller' => 'Questions', 'actions' => 'view', $answer->question_id]);
    }
    ...
    {
        //$this->request->allowMethod(['post']); ※beforeFilter()でやっているから不要
